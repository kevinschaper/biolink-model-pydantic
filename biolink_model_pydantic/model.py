...
# Generation date: 2021-09-17 15:57
...
class Agent(AdministrativeEntity):
    ...
    id: URIorCURIE = None
    affiliation: Optional[Union[Union[str, URIorCURIE], List[Union[str, URIorCURIE]]]] = field(default_factory=list)
...
class Publication(InformationContentEntity):
    ...
    mesh_terms: Optional[Union[Union[str, URIorCURIE], List[Union[str, URIorCURIE]]]] = field(default_factory=list)
...
class ThingWithTaxon:
    ...
    """
    in_taxon: Optional[Union[Union[URIorCURIE, OrganismTaxon], List[Union[URIorCURIE, OrganismTaxon]]]] = field(default_factory=list)
...
class GeneGroupingMixin:
    ...
    """
    has_gene_or_gene_product: Optional[Union[Union[URIorCURIE, Gene], List[Union[URIorCURIE, Gene]]]] = field(default_factory=list)
...
class SequenceVariant(NucleicAcidEntity):
    ...
    id: URIorCURIE = None
    has_gene: Optional[Union[Union[URIorCURIE, Gene], List[Union[URIorCURIE, Gene]]]] = field(default_factory=list)
    has_biological_sequence: Optional[Union[str, BiologicalSequence]] = None
...
@dataclass(config=PydanticConfig)
class GenomicBackgroundExposure(BiologicalEntity, ExposureEvent, GeneGroupingMixin, PhysicalEssence, GenomicEntity):
    """
...
class Treatment(NamedThing, ExposureEvent, ChemicalOrDrugOrTreatment):
    ...
    has_drug: Optional[Union[Union[URIorCURIE, Drug], List[Union[URIorCURIE, Drug]]]] = field(default_factory=list)
    has_device: Optional[Union[Union[URIorCURIE, Device], List[Union[URIorCURIE, Device]]]] = field(default_factory=list)
    has_procedure: Optional[Union[Union[URIorCURIE, Procedure], List[Union[URIorCURIE, Procedure]]]] = field(default_factory=list)
...
class Association(Entity):
    ...
    publications: Optional[Union[Union[URIorCURIE, Publication], List[Union[URIorCURIE, Publication]]]] = field(default_factory=list)
    type: Optional[Union[str, str]] = None
    category: Optional[Union[URIorCURIE, List[URIorCURIE]]] = field(default_factory=list)
